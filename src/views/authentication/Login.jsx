        ...
        <>
...

            {
                showData && <section className="text-center text-lg-start">
                    ...
                    <div className="mb-3" id="login__div">
                        <div className="row g-0 d-flex align-items-center">
                            <div className="col-lg-4 d-none d-lg-flex ">
                                <img src="/img/login.png" alt="Trendy Pants and Shoes"
                                    className="w-100 rounded-t-5 rounded-tr-lg-0 rounded-bl-lg-5 mx-2 login__img" />
                            </div>
                            {
                                user ? <div className="col-lg-8 my-2">
                                ...
                                </div> : vendor ? <div className="col-lg-8 my-2">
