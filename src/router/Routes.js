...
import UserResetPassword3, {UserResetPassword4} from '../views/authentication/reset_password/user__reset_password/UserResetPassword_3'
...
import VendorResetPassword3, {VendorResetPassword4} from '../views/authentication/reset_password/vendor__reset_password/VendorResetPassword_3'
...
const AllRoutes = () =>{
    const routes = useRoutes([
        ...
        {
            path: "/user_resetPassword_4",
            element: <UserResetPassword4 />
        },
        {
        ...
        {
            path: "/vendor_resetPassword_4",
            element: <VendorResetPassword4 />
        },
        {
            path: "/user_home",
            element: <UserHome />
